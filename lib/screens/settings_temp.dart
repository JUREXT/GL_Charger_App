...
class SettingTempScreen extends StatefulWidget {
  @override
  _SettingTempScreenState createState() => _SettingTempScreenState();
}

class _SettingTempScreenState extends State<SettingTempScreen> {
  @override
